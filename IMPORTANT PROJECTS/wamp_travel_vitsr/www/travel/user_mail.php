...
$message="<b>to start using our site goto  <a href='http://localhost/travel/user_link.php?verify=$code'>get started</a><b>";
...
?>
				...
				<p class="obj2">
				MAIL SENT TO YOUR EMAIL! VERIFY YOUR EMAIL ADDRESS!!
				</p>
			</div>
