...
<?php
	...
	$alter=mysql_query("SELECT * from train where srno='$ei'");
...
if($value==1)
{
	...
	$edit="UPDATE train SET tno='$tno1',tname='$tname1',source='$source1',destin='$destin1',arival='$arival1',dept='$dept1',date='$date1',day='$day1',status='$status1'  WHERE srno='$ei'";
   	mysql_query($edit);
	echo "successful";
	?>
	</br></br>
	<a class="obj1" href="trains.php"> Go back</a>
	<?php
...
?>
		...
		<center>
		<table>
			<form action ="altert.php?value=1&id=<?php echo $ei?>" method="post" enctype="multipart/form-data"> 
				<tr>
					<td class="obj1" >Number: <br/></td>
					<td class="obj1" colspan="4"><input type="text" maxlength="19" name="tno" value="<?php echo $tno?>"/><br/></td>
				</tr>
				<tr>
					<td class="obj1" >Name: <br/></td>
					<td class="obj1" colspan="4"><input type="text" maxlength="19" name="tname" value="<?php echo $tname?>"/><br/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="obj1" colspan="4"><input type="day" maxlength="19" name="day" value="<?php echo $day?>"/><br/></td>
				</tr>
				<tr>
