<html>
	...
	?>
				<h2 class="obj1"> Add Flights</h2>
	
	
				<center>
		<table>
			<form action ="flights.php?value=1" method="post" enctype="multipart/form-data"> 
				<tr>
				...
				<tr>
					<td class="obj1" >Class_b cost<br/></td>
					<td class="obj1" colspan="4"><input type="number" name="class_a1" /><br/></td>
				</tr>
				<tr>
					<td class="obj1" >class_e cost<br/></td>
	...
	$dept1=$_POST['dept'];
	$date1=$_POST['date'];
	$class_e=$_POST['class_a2'];
	$class_b=$_POST['class_a1'];
	$status1=$_POST['status'];
		mysql_query("insert into flight(fno,fname,source,destin,arival,dept,class_e,class_b,date,status) values('$tno1','$tname1','$source1','$destin1','$arival1','$dept1',$class_e,$class_b,'$date1',$status1)");
		}
		$extract=mysql_query("SELECT srno,fno,fname,source,destin,arival,dept,date,status from flight");
			?>
		<html>
		<body>
			<table border=1>
			...
			?>
				...
				<tr>
					...
					<td class="obj1"> <a href="deletef.php?id=<?php echo $row[0] ?>">delete </a>
					</td>
					<td class="obj1"> <a href="alterf.php?id=<?php echo $row[0]?>"> edit </a>
					</td>
