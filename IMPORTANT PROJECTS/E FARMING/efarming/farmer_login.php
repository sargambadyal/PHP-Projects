...
<div id="wrapper">
	...
	<div id="page" class="container">
		...
		<h1> Farmers Login</h1>
					...
					<form name="myForm" action="farmer_login.php?hello=1" onsubmit="return validation()" method="post">
						<table>
						...
						if($value==1)
							{
								...
								//echo "lol";
								$result=mysql_query("select * from farmer where username='$username' and password='$password' ");
								...
								if($row['username']!=NUll || $row['username']!=' ')
									...
									//echo $row['id'];
									?>
									<a class="obj1"href="farmer.php?id=<?php echo $row['email']?>&v=<?php echo $row['name']?>"> Go to home page</a>
									<?php
	...
	<div id="footer">
		<p>Copyright (c) Sargam,Sadhana,Aditi</p>
	</div>
</div>
</body>
</html>
